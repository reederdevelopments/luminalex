...
func ensureSurveysTable(ctx context.Context, dataset *bigquery.Dataset) error {
	...
	schema := bigquery.Schema{
		...
		{Name: "instructions", Type: bigquery.StringFieldType},
		{Name: "thank_you_message", Type: bigquery.StringFieldType},
		{Name: "email_body_create", Type: bigquery.StringFieldType},
		{Name: "email_body_reminder", Type: bigquery.StringFieldType},
